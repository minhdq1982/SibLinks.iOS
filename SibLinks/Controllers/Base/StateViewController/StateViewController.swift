...
enum StateViewControllerState: String {
...
/// StateViewController protocol may be adopted by a view controller or a view in order to transition to
/// error, loading or empty views.
protocol StateViewController: class, BackingViewProvider {
    ...
    var currentState: StateViewControllerState { get }
    ...
    var lastState: StateViewControllerState { get }
