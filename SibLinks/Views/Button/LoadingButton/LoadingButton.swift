...
enum ActivityIndicatorAlignment: Int {
    case Left
    case Center
    case Right
...
class LoadingButton: AnimatableButton {
    ...
    var hideImageWhenLoading:Bool = true {
        didSet {
            configureControlState(currentControlState());
        }
    }
    var hideTextWhenLoading:Bool = true {
        didSet {
            configureControlState(currentControlState());
        }
    }
    
    var activityIndicatorEdgeInsets:UIEdgeInsets = UIEdgeInsetsZero
    
    /** Loading Alingment */
    var activityIndicatorAlignment:ActivityIndicatorAlignment = ActivityIndicatorAlignment.Center {
        didSet {
            self.setNeedsLayout()
        }
    }
    ...
    func setActivityIndicatorAlignment(alignment: ActivityIndicatorAlignment) {
