...
@objc class PlaybackLayer: CALayer {
    ...
    var playbackAnimationDuration: CFTimeInterval = PlaybackButton.kDefaultDuration
...
@objc class PlaybackButton : AnimatableButton {
    
    static let kDefaultDuration: CFTimeInterval = 0.24
    var playbackLayer: PlaybackLayer?
    var animationDuration: CFTimeInterval = PlaybackButton.kDefaultDuration {
        didSet {
            self.playbackLayer?.playbackAnimationDuration = self.animationDuration
        }
    }
    ...
    func setButtonColor(color: UIColor, buttonState: PlaybackButtonState) {
        switch buttonState {
        case .None:
            break
        case .Pausing:
    ...
    private func addPlaybackLayer() {
        ...
        playbackLayer.playbackAnimationDuration = self.animationDuration
